...
certificateUse1 = {
	...
	updateData: function(){
		...
		sigStyles.align = "center"//theSigProps.children('font').attr("align");
	...
	doUpdate: function() {
		...
		//setup sigHolder
		elem.innerHTML += "<div class='items2'  tabindex="+(tabindex+4)+">" + generalStyles.sigHolder + "</div>";		
